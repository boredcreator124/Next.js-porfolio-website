...
const Contact = () => {
  ...
  const personalInfo = {
    email: 'jacobniilanteibaddoo6@gmail.com',
    phone: '0268237447',
  };

  // Social links
  const contactLinks = [
    { platform: 'LinkedIn', url: 'www.linkedin.com/in/jacob-baddoo-687573310' },
    { platform: 'GitHub', url: 'https://github.com/boredcreator124' },
  ];
